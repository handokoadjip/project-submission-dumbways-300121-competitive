              ...
              <div class="row">
                <div class="col-md-12 mb-4">
                  <div class="input-group-append">
                    <a href="school_create.php" class="btn btn-sm btn-primary btn-block mr-3">
                      <i class="fa fa-plus mr-2"></i>Add School
                    </a>
                    <a href="school_active.php" class="btn btn-sm btn-default btn-block mr-3">
                      School Active
                    </a>
                    <a href="school_deactive.php" class="btn btn-sm btn-default btn-block mr-3">
                      School Deactive
                    </a>
                    <a href="school_my.php" class="btn btn-sm btn-default btn-block mr-3">
                      My School
                    </a>
                  </div>
                </div>
