...
<head>
  ...
  <title>School - Create School</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="employee.html">School</a></li>
                ...
                <div class="card-body box-profile">
                  <form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control b-left" id="NPSN" name="NPSN" placeholder="NPSN" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control b-left" id="name_school" name="name_school" placeholder="school name" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <textarea type="text" class="form-control b-left" id="address" name="address" placeholder="address"></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control b-left" id="school_level" name="school_level" placeholder="level school" />
                    ...
                    <div class="form-group row">
                      <div class="offset-sm-2 col-md-2 col-sm-10 mt-5">
                        <button type="submit" class="btn btn-block btn-primary" name="submit">
                          <i class="fab fa-telegram-plane mr-2"></i>Save
                        </button>
                      </div>
                    </div>
                  </form>
